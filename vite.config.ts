...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: ["homebrew.svg", "favicon.ico", "robots.txt"],
      manifest: {
        name: "Brew Graph - Homebrew Package Explorer",
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            urlPattern: /^https:\/\/formulae\.brew\.sh\/api\/.*/i,
            handler: "NetworkFirst",
            options: {
              cacheName: "brew-api-cache",
              expiration: {
                maxEntries: 50,
